...
// Show medicine details with alerts and sale messages
function showMedicineDetails(index) {
  ...
  if (diffDays < 0) {
    ...
    if (med.offer) {
      alertMsg += ` 🎁 Offer: ${med.offer} – Keep any offer to sale the product!`;
    } else {
      alertMsg += ` – Keep any offer to sale the product!`;
    }
  } else {
    alertMsg = "✅ Safe";
  }
